...
SecondNumberActor::SecondNumberActor() : m_Value(1), m_NumberCount(0)
{
}


SecondNumberActor::~SecondNumberActor()
{
}

void SecondNumberActor::NumberInit(size_t _NumberCount, const WCHAR * _Name, FSIZE _Numbersize)
{
	...
	{
		SingleActorRender* Render = MakeRender<SingleActorRender>(27);
...
void SecondNumberActor::Init()
{

}

void SecondNumberActor::PrevUpdate()
{

}

void SecondNumberActor::Update()
{
	int Count = 0;
...
void SecondNumberActor::LaterUpdate()
{
